...
<!-- Left Sidebar End -->
        ...
        <!-- JAVASCRIPT -->
        <script src="{{asset('asset5/asset/libs/jquery/jquery.min.js')}}"></script>
        <script src="{{asset('asset5/asset/libs/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
        <script src="{{asset('asset5/asset/libs/metismenu/metisMenu.min.js')}}"></script>
        <script src="{{asset('asset5/asset/libs/simplebar/simplebar.min.js')}}"></script>
        <script src="{{asset('asset5/asset/libs/node-waves/waves.min.js')}}"></script>

        <!-- apexcharts -->
        <script src="{{asset('asset5/asset/libs/apexcharts/apexcharts.min.js')}}"></script>

        <script src="{{asset('asset5/asset/js/pages/dashboard.init.js')}}"></script>

        <!-- App js -->
        <script src="{{asset('asset5/asset/js/app.js')}}"></script>
    </body>
