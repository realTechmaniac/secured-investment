                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="alert alert-success" role="alert">
                            <h5>Welcome Ayomide Adebayo please enter your Investment details below.</h5>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card border ">
                                    <div class="card-header bg-transparent border-primary">
                                        <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow mr-3"></i>Provide Help</h5>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text">Please fill in your proposed investment amount in the form below.</p>
                                        ...
                                        <form>
                                          ...
                                          <div class="my-4 text-center">
                                            <!-- Small modal -->
                                            <button type="button" class="btn btn-primary waves-effect waves-light font-weight-bold " data-toggle="modal" data-target=".bs-example-modal-center">Provide Help</button>
                                        </div>
