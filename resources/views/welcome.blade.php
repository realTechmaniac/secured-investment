    ...
    <section class="screen_area text-center p_120">
        <div class="container">
            <div class="main_title">
                ...
                <a class="main_btn text-center mt-3" href="{{route('register')}}">Register Now !</a>
            </div>
                ...
                <div class="row made_life_text">
                    <div class="col-lg-6">
                        <div class="left_side_text">
                            ...
                            <a class="main_btn" href="{{route('login')}}">Get Started Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="chart_img">
    ...
    <section class="impress_area p_120">
        <div class="container">
            <div class="impress_inner">
                ...
                <a class="banner_btn2" href="{{route('register')}}">Register Now</a>
            </div>
        </div>
    </section>
    <!--================End Impress Area =================-->
                ...
                <div class="row made_life_text">
                    <div class="col-lg-6">
                        <div class="left_side_text">
                            ...
                            <h6>We are here to deliver quality investment services</h6>
                            <p>SECURED INVESTMENT is a peer to peer financial home created to grant financial freedom to all human race.<strong>SECURED INVESTMENT provides 50% profit in  2 days (24 hours) and subsquently in 4 days (96 hours)</strong>.</p>
                            <a class="main_btn" href="{{route('register')}}">Get Started Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="chart_img">
