                       ...
                       <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="pt-3">
                                        <h5 class="text-justify">Your request to Get Help is Pending. You will be merged very soon. However, if you like to change your mind, you can cancel your request to Get help. <a href="" class="btn btn-danger mt-2" data-toggle="modal" data-target=".bs-example-modal-center">Cancel GH</a></h5>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="swal2-header">
                                                                    <h5><strong>Are you sure you want to cancel your Get Help Help Request ? </strong></h5>
                                                                </div>
