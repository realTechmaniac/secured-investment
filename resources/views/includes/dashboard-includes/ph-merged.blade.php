                                        ...
                                        @if($unconfirmed_gh->receiptUploads->count() > 0)
                                            @if(in_array($unconfirmed_gh->merge->provide_help_id, array_column($unconfirmed_gh->receiptUploads->toArray(), 'provide_help_id')))
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target=".ph-regular-merged-modal-{{$unconfirmed_gh->receiptUploads->toArray()[array_search($unconfirmed_gh->merge->provide_help_id, array_column($unconfirmed_gh->receiptUploads->toArray(), 'provide_help_id'))]['token']}}">
                                                    View Receipt
                                                </button>
                                            @else
                                                <form
