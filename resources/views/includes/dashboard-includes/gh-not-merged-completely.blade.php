                                        ...
                                        @if($unconfirmed_ph->receiptUploads->count() > 0)
                                            @if(\App\ProvideHelp::ghReceiptExist($unconfirmed_ph, 'get_help_id'))
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target=".gh-show-receipt-not-complete-modal-{{\App\ProvideHelp::ghGetKeyValue($unconfirmed_ph,'get_help_id', 'token')}}">
                                                    View Receipt
                                                </button>
                                                @if(!\App\ProvideHelp::ghGetKeyValue($unconfirmed_ph,'get_help_id', 'is_fake'))
                                                    <button type="button"
                                                            ...
                                                            data-toggle="modal"
                                                            data-target=".gh-report-receipt-not-complete-modal-{{\App\ProvideHelp::ghGetKeyValue($unconfirmed_ph,'get_help_id', 'token')}}">
                                                        Report Receipt
                                                    </button>
                                                @endif
                                            @else
