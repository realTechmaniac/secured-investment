<div class="row">
    <div class="col-12">
                                        ...
                                        @if($unconfirmed_gh->receiptUploads->count() > 0)
                                            @if(\App\GetHelp::receiptExist($unconfirmed_gh, 'provide_help_id'))
                                                <button type="button"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target=".ph-activation-not-complete-modal-{{\App\GetHelp::getKeyValue($unconfirmed_gh,'provide_help_id', 'token')}}">
                                                    View Receipt
                                                </button>
                                            @else
                                                <form
        ...
        {{--PH Merge Info--}}
        @include('includes.activation-reactivation-merge-info')
    </div>
</div>
