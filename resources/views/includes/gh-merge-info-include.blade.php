            ...
            <div class="card-body">
                ...
                <div class="card-title-desc">
                    <ol>
                        ...
                        <li>If a user <b class="text-danger">does not pay</b> you before merge expires, you be <b class="text-danger">automatically unmerged</b> from such user and you will be <b class="text-primary">re-merged</b> with another user shortly after.</li>
                    </ol>
                </div>
                <hr>
