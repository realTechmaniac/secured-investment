...
@section('page-title')Secured Investment -Admin | Merge Pending Provide Help @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Admin- Merge Pending Provide Help</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                            ...
                                            @if($pending_ph->count() > 0)
                                                @foreach($pending_ph as $ph)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('edit.user.details', $ph->user->token)}}">
                                                                <i class="bx bx-user bx-sm mr-1 " data-toggle="tooltip"
                                                                   data-placement="top" title="View {{$ph->user->username}}'s Profile"></i>
                                                            </a>
